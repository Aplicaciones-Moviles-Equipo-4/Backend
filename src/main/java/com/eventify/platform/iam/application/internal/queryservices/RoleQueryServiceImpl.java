package com.eventify.platform.iam.application.internal.queryservices;

import com.eventify.platform.iam.domain.model.entities.Role;
import com.eventify.platform.iam.domain.model.queries.GetAllRolesQuery;
import com.eventify.platform.iam.domain.model.queries.GetRoleByNameQuery;
import com.eventify.platform.iam.domain.services.RoleQueryService;
...
public class RoleQueryServiceImpl implements RoleQueryService {
    ...
    public Optional<Role> handle(GetRoleByNameQuery query) {
        return roleRepository.findFirstByNameOrderByIdAsc(query.name());
    }
}
